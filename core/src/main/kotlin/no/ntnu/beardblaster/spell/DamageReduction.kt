...
class DamageReduction(wizardId: String, activatedAtTurn: Int, duration: Int, amount: Int) :
    MitigationSpell(wizardId, activatedAtTurn + 1, duration, amount) {
    override fun isActive(
        ...
        return turn in activatedAtTurn..activatedAtTurn+duration && opponentWizardId != null && opponentWizardId == wizardId
    }
